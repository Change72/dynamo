...
def build_sampling_params(
    ...
    # Read the Router-attached remote_kv_reuse_plan from request.extra_args
    # and pass it through in vLLM's kv_transfer_params["remote_g2_plan"] shape.
    try:
        ...
        logger.warning("native router plan adapter failed: %s", _exc)
